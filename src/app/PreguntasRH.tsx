    ...
    return (
        <div className="m-4 mr-5 font-general-regular text-left">
            <form onSubmit={handleSubmit}>
                <label htmlFor="personalCont" className="block text-sm font-medium leading-6 text-gray-900">
                    ¿Cuánto personal se encuentra contratado en la clínica en el turno?
                </label>
                <div className="">
                    <select
                        id="personalCont"
                    ...
                    >
                        <option value="personalCont0"> Doctores </option>
                        <option value="personalCont1">Jurisdicción Sanitaria 1 (Querétaro)</option>
                        <option value="personalCont2">Jurisdicción Sanitaria 2 (San Juan del Río)</option>
                        <option value="personalCont3">Jurisdicción Sanitaria 3 (Cadereyta de Montes)</option>
                        <option value="personalCont4">Jurisdicción Sanitaria 4 (Jalpan de Serra)</option>
                    </select>
                </div>
