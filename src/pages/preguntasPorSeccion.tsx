...
export const preguntasPorSeccion: { titulo: string; preguntas: Pregunta[]; }[] = [
    {
        ...
        preguntas: [
            { id: 'nombre_encuestador', texto: 'Nombre del encuestador', tipo: 'texto', ponderacion: 0 },
            { id: 'pregunta_01', texto: 'Bitácoras de acceso a unidad', tipo: 'checkbox', ponderacion: 0.5 },
            { id: 'pregunta_02', texto: 'Porcentaje del personal en turno que se encuentra en este momento en la unidad', tipo: 'texto', ponderacion: 1 },
            { id: 'pregunta_03', texto: 'Porcentaje del personal del turno que se encuentra en su área de trabajo haciendo las actividades que le corresponden', tipo: 'texto', ponderacion: 3 },
            { id: 'pregunta_04', texto: 'El personal porta gafete visible', tipo: 'checkboxdual', ponderacion: 0.5 },
            { id: 'pregunta_05', texto: 'Productividad de consulta reportada de los últimos 2 meses', tipo: 'texto', ponderacion: 3 },
            { id: 'pregunta_06', texto: 'Reloj checador', tipo: 'checkboxdual', ponderacion: 0.5 },
            { id: 'pregunta_07', texto: 'Carpeta de expediente de recursos humanos', tipo: 'checkboxdual', ponderacion: 0.5 },
            { id: 'pregunta_08', texto: 'Electrocardiogramas realizados en bitácora en los últimos 2 meses', tipo: 'texto', ponderacion: 1 },
        ],
    },
    {
        titulo: 'Mantenimiento y otras condiciones de la unidad',
        preguntas: [
            { id: 'supervisor_01', texto: 'Nombre de responsable de unidad', tipo: 'texto', ponderacion: 0 },
    ...
    },
    {
        ...
        preguntas: [
            { id: 'supervisor_02', texto: 'Nombre de personal de supervisión de primer contacto', tipo: 'texto', ponderacion: 0 },
            ...
            { id: 'pregunta_16', texto: 'Coinciden px en agenda (que llegaron) con hoja diaria médica', tipo: 'checkbox', ponderacion: 1 },
        ],
    },
    {
    ...
    },
    {
        titulo: 'Somatometría',
        preguntas: [
            { id: 'supervisor_03', texto: 'Nombre de Enfermera de supervisión', tipo: 'texto', ponderacion: 0 },
            { id: 'pregunta_23', texto: 'Báscula con estadímetro', tipo: 'checkboxdual', ponderacion: 0.5 },
            { id: 'pregunta_24', texto: 'Báscula pesa bebé', tipo: 'checkboxdual', ponderacion: 0.5 },
            { id: 'pregunta_25', texto: 'Pesas patrón', tipo: 'checkboxdual', ponderacion: 0.2 },
            { id: 'pregunta_26', texto: 'Hoja diaria de enfermería', tipo: 'checkbox', ponderacion: 0.6 },
            { id: 'pregunta_27', texto: 'Termómetro', tipo: 'checkboxdual', ponderacion: 0.4 },
            { id: 'pregunta_28', texto: 'Glucómetro', tipo: 'checkboxdual', ponderacion: 1 },
            { id: 'pregunta_29', texto: 'Esfigmomanómetro', tipo: 'checkboxdual', ponderacion: 0.5 },
            { id: 'pregunta_30', texto: 'Estetoscopio', tipo: 'checkboxdual', ponderacion: 0.4 },
            { id: 'pregunta_31', texto: 'Oxímetro', tipo: 'checkboxdual', ponderacion: 0.4 },
            ...
            { id: 'pregunta_35', texto: 'Pruebas de VIH, VDRL', tipo: 'checkboxdual', ponderacion: 0.3 },
            { id: 'pregunta_36', texto: 'Cardiocheck con tiras', tipo: 'checkboxdual', ponderacion: 1 },
            { id: 'pregunta_37', texto: 'Sello de  RCV', tipo: 'checkboxdual', ponderacion: 0.2 },
            ...
            { id: 'pregunta_41', texto: 'Bitácora de mantenimiento  prev de equipo', tipo: 'checkbox', ponderacion: 0.1 },
    ...
    },
    {
        ...
        preguntas: [
            ...
            { id: 'pregunta_45', texto: 'Insumos presentes y semaforizados', tipo: 'checkbox', ponderacion: 0.3 },
            ...
            { id: 'pregunta_57', texto: 'Bitácora seg displasias', tipo: 'checkbox', ponderacion: 0.5 },
    ...
    },
    {
        ...
        preguntas: [
            ...
            { id: 'pregunta_66', texto: 'No dar citas (excepto BCG)', tipo: 'checkbox', ponderacion: 0.7 },
            ...
            { id: 'pregunta_71', texto: 'Bitácora limpieza refri', tipo: 'checkbox', ponderacion: 0.1 },
    ...
    },
    {
        titulo: 'Farmacia',
        preguntas: [
            { id: 'supervisor_04', texto: 'Nombre del responsable de Farmacia', tipo: 'texto', ponderacion: 0 },
            { id: 'pregunta_82', texto: 'Termohigrómetro', tipo: 'checkboxdual', ponderacion: 0.1 },
            { id: 'pregunta_83', texto: 'Medicamentos lasa y alto riesgo', tipo: 'checkbox', ponderacion: 0.4 },
            { id: 'pregunta_84', texto: 'Semaforización y orden medicamentos y material de curación', tipo: 'checkbox', ponderacion: 2 },
            { id: 'pregunta_85', texto: 'Con lector óptico', tipo: 'checkboxdual', ponderacion: 1 },
            { id: 'pregunta_86', texto: 'Congruencia fisica y en sistema de 10 claves de medicamentos y 5 de material de curación', tipo: 'texto', ponderacion: 6 },
            { id: 'pregunta_87', texto: 'SIAM actualizado', tipo: 'checkboxdual', ponderacion: 1 },
            { id: 'pregunta_88', texto: 'Archivos simed max 3 días de retraso', tipo: 'checkboxdual', ponderacion: 1.5 },
    ...
    },
    {
        titulo: 'Consultorio',
        preguntas: [
            { id: 'supervisor_05', texto: 'Médico a evaluar', tipo: 'texto', ponderacion: 0 },
    ...
    },
    {
        ...
        preguntas: [
            { id: 'expediente_01', texto: 'Expediente 1', tipo: 'selec', ponderacion: 0 },
            { id: 'pregunta_111', texto: 'De acuerdo al algoritmo de manejo de paciente diabetico califique el manejo que se le ha dado a este paciente', tipo: 'exp1d', ponderacion: 2 },
            { id: 'pregunta_112', texto: 'Correcta selección de fármacos', tipo: 'exp1d', ponderacion: 1.5 },
            { id: 'pregunta_113', texto: 'De acuerdo al algoritmo de manejo de paciente hipertenso califique el manejo que se le ha dado a este paciente', tipo: 'exp1h', ponderacion: 2 },
            ...
            { id: 'pregunta_116', texto: 'Nombre completo y fecha de nacimiento en todo documento', tipo: 'checkboxdual', ponderacion: 0.3 },
            { id: 'pregunta_117', texto: 'Riesgo de Caídas', tipo: 'checkboxdual', ponderacion: 0.2 },
            //IRAS
            ...
            { id: 'pregunta_127', texto: 'De acuerdo al manejo seleccionado ¿el esquema y posología es el adecuado?', tipo: 'exp2Iv', ponderacion: 0.5 },
            //GEPI
            ...
            { id: 'pregunta_131', texto: 'De acuerdo al manejo seleccionado ¿el esquema y posología es el adecuado?', tipo: 'opcional4', ponderacion: 0.5 },
            { id: 'pregunta_132', texto: 'Esquema de Hidratacion', tipo: 'exp2Ge', ponderacion: 0.5 },
            { id: 'pregunta_133', texto: 'Congruencia de Cuadro Clínico - Diagnostico - Tratamiento', tipo: 'checkboxdualW', ponderacion: 1 },
            { id: 'pregunta_134', texto: 'Nombre completo y fecha de nacimiento en todo documento', tipo: 'checkboxdualW', ponderacion: 0.3 },
            { id: 'pregunta_135', texto: 'Riesgo de Caídas', tipo: 'checkboxdualW', ponderacion: 0.2 },
            // EXP 3 Niño sano
            { id: 'expediente_03', texto: 'Expediente 3', tipo: 'selec3', ponderacion: 0 },
            ...
            //Embarazo
            { id: 'pregunta_140', texto: 'Se entregaron suplementos FE y acido fólico', tipo: 'exp3Em', ponderacion: 1 },
            { id: 'pregunta_141', texto: 'Se registró la frecuencia cardiaca fetal ', tipo: 'exp3Em', ponderacion: 1.5 },
            { id: 'pregunta_142', texto: '¿Es embarazada de alto riesgo o semana 36 o más?', tipo: 'exp3Em', ponderacion: 1 }, //si, aparece la siguiente:
            { id: 'pregunta_143', texto: 'Referencia a las embarazadas de alto riesgo o en semana de gestacion 36', tipo: 'exp3Em', ponderacion: 1 },

            { id: 'pregunta_144', texto: 'Congruencia de Cuadro Clínico Diagnostico Tratamiento', tipo: 'checkboxdual', ponderacion: 1 },
            { id: 'pregunta_145', texto: 'Nombre completo y fecha de nacimiento en todo documento ', tipo: 'checkboxdual', ponderacion: 0.3 },
            { id: 'pregunta_146', texto: 'Riesgo de caídas', tipo: 'checkboxdual', ponderacion: 0.2 },
        ],
    },
    //Secciones
];
